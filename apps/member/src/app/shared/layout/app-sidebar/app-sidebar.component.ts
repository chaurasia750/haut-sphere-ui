...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      section: "MAIN",
      subItems: [
        { name: "Dashboard", path: "/member/leads-dashboard" },
        { name: "List", path: "/member/leads-list" },
        { name: "Add Lead", path: "/member/leads-add" },
      ],
    },
    {
      ...
      section: "MAIN",
      subItems: [
        { name: "List", path: "/member/inventory/list" },
      ],
    },
    {
