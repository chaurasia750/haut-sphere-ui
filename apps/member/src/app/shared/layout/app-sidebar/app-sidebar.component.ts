...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        { name: "Upgrade Request", path: "/upgrade-request" },
        { name: "KYC Details", path: "/kyc-details" },
      ],
    },
    {
      ...
      subItems: [
        { name: "Sponsor New", path: "/sponsor-new" },
        { name: "Edit Profile", path: "/edit-profile" },
        { name: "View Profile", path: "/view-profile" },
        { name: "Welcome Letter", path: "/welcome-letter" },
      ],
    },
    {
      ...
      subItems: [
        ...
        { name: "matching Tree", path: "/matching-tree" },
        { name: "Matrix tree", path: "/matrix-tree" },
        { name: "Downline List", path: "/downline-list" },
      ],
    },
    {
      ...
      name: "level Manager",
      subItems: [{ name: "Level Details", path: "/level-details" }],
    },
    {
      ...
      subItems: [{ name: "Payout Request", path: "/payout-request" }],
    },
    {
    ...
    },
    {
      ...
      name: "Your Company Bank Details",
      path: "/bank-details",
    },
    {
      ...
      subItems: [
        ...
        { name: "Compose Mail", path: "/compose-mail" },
        { name: "Sent Mail", path: "/sent-mail" },
      ],
    },
    {
